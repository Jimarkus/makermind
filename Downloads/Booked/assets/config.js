...
window.MM_CONFIG = {
  ...
  scheduler: {
    ...
    // where to send someone once they have actually booked. This is the
    // page to point Google Ads and Analytics at as the conversion, since
    // it can only load after a booking completes. Set to '' to leave
    // visitors on Calendly's own confirmation screen instead.
    confirmPage: 'booked.html',
    hideDetails: false,
