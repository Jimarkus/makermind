...
(function () {
  ...
  if (provider === 'cal') {
    ...
    /* ---- send the visitor to a real confirmation page ----------------
       ...
       The origin check and the event name are Calendly's documented
       ones. Set scheduler.confirmPage to '' in config.js to switch this
       off and leave visitors on Calendly's own confirmation screen. */
